    ...
    <nav class="navbar navbar-custom navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">BeliBuku</a>
            </div>
            <div class="navbar-collapse collapse" id="searchbar">
                <ul class="nav navbar-nav navbar-left">
                    <li id="userPage">
                        <a href="#@userpage"><i class="fa fa-icon-user"></i>Pencarian</a>
                    </li>
                </ul>
                ...
                <?php echo form_open('home/cari',array('method'=>'GET','class'=>'navbar-form','id'=>'myform','onsubmit'=>'return changeurl()'));  ?>
